    ...
    >
      ...
      >
        <view class="u-scroll-list__indicator__line" :style="[lineStyle]">
          <view ref="u-scroll-list__indicator__line__bar" class="u-scroll-list__indicator__line__bar" :style="[barStyle]" />
        </view>
      </view>
  </view>
</template>

<script src="uview-plus/components/u-scroll-list/scrollWxs.wxs" module="wxs" lang="wxs"></script>
...
import nvueMixin from 'uview-plus/components/u-scroll-list/nvue.js'
// #endif
import props from 'uview-plus/components/u-scroll-list/props.js'
  ...
  methods: {
    ...
    scrolltolowerHandler() {
      ...
      this.scrollInfo.scrollLeft =
        uni.$u.getPx(this.indicatorWidth) - uni.$u.getPx(this.indicatorBarWidth)
    },
    // #endif
    //
    scrollEvent(status) {
